...
//    There are many different types of combat units in the IDF, they all have their own specialties. Some of the units are co-ed and some require a gibbush (tryouts). To get into a combat unit you need a profile of at least a 72, although some units require higher.
    ...
    let unit20 = Unit(image: #imageLiteral(resourceName: "oz"), title: "Oz עוז", summary: "Infantry Corps", description: "Color of Kumta: Red, Brown and Purple\("\r\n")Description: The newest brigade made up of only special forces such as Rimon, Maglan, Egoz and Duvdevan. See Commando Page for more details. Profile: 97 (Gibbush Needed)")
    ...
    let unit18 = Unit(image: #imageLiteral(resourceName: "gun"), title: "Hadracha הדרכה", summary: "Instructors", description: "There are many different types of instructors (Female and Male) that teach soldiers how to operate weapons, machinery, tanks, and other devices. Common positions include Chir, Tank, Artillery and more.")
    ...
    let unit22 = Unit(image: #imageLiteral(resourceName: "keladavid"), title: "Kela David קלע דוד", summary: "Special Artillery" , description: "Also known as אגד 214. Women are now also allowed to tryout and join the elite units of Moran, Meitar and Skyrider as combat soldiers, commanders, and officers.")
