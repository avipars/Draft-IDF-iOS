...
class NonCombatList: UIViewController {
    ...
    func createArray() -> [Unit] {
        ...
        let unit0 = Unit(image: #imageLiteral(resourceName: "ic_supervisor_account"), title: "Mashakiot מ״שקית", summary: "Non-Commissioned Officers", description: "A non-commissioned officer that oversees other soldiers and fulfils an official role in each unit. The most common positions are Mashakit Tash, Hinuch, Aliyah, Shalishut, and Hod.")
